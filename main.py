...
# Словник з картками водіїв (враховуємо можливі варіанти написання імені)
DRIVER_CARDS = {
...
async def process_accept(callback: types.CallbackQuery):
    ...
    # Шукаємо картку за ім'ям водія, якщо не знайдено — даємо картку Макса за замовчуванням
    ...
    # Формуємо відповідь клієнту з правильним номером картки
    client_reply = (
